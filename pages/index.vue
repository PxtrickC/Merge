...
<template>
  <div>
    ...
    <section-ranking :title="`Yellow Mass ${yellow_mass?.length ?? 0}/94`" :items="yellow_mass" :alpha-mass="alpha_mass" />
    <section-ranking :title="`Blue Mass ${blue_mass?.length ?? 0}/50`" :items="blue_mass" :alpha-mass="alpha_mass" />
